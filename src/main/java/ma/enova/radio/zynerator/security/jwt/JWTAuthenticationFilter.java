package ma.enova.radio.zynerator.security.jwt;
...
import ma.enova.radio.RadioApplication;
import ma.enova.radio.zynerator.security.common.SecurityParams;
...
public class JWTAuthenticationFilter extends UsernamePasswordAuthenticationFilter {
    ...
    protected void successfulAuthentication(HttpServletRequest request, HttpServletResponse response,
        ...
        UserService userService = RadioApplication.getCtx().getBean(UserService.class);
