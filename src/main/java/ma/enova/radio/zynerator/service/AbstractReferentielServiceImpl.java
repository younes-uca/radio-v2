...
public abstract class AbstractReferentielServiceImpl<T extends AuditBusinessObjectEnhanced, DTO extends ReferentielBaseDto, H extends HistBusinessObject, CRITERIA extends BaseCriteria, HC extends HistCriteria, REPO extends AbstractRepository<T, Long>, HISTREPO extends AbstractHistoryRepository<H, Long>, CONV extends AbstractReferentielConverter<T, DTO, H>> extends AbstractServiceImplHelper<T> {
    ...
    protected AbstractReferentielConverter<T, DTO, H> abstractConverter;

    protected Class<T> itemClass;
    protected Class<DTO> dtoClass;


    public AbstractReferentielServiceImpl(REPO dao, HISTREPO historyRepository, CONV abstractConverter) {
        this.dao = dao;
...
*/
    ...
    public AuditEntityDto findHistoryById(Long id) {
        ...
        // TODO: correct ==> return (AuditEntityDto) abstractConverter.copyFromHistory(h);
        return null;
    }
    ...
    public List<AuditEntityDto> findHistoryPaginatedByCriteria(HC historyCriteria, int page, int pageSize, String order, String sortField) {
        ...
        // TODO: correct ==> return content.stream().map(h -> (AuditEntityDto) abstractConverter.copyFromHistory(h)).collect(Collectors.toList());
        return null;
    }
