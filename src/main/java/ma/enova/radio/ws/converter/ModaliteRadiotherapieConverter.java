...
@Component
public class ModaliteRadiotherapieConverter extends AbstractReferentielConverter<ModaliteRadiotherapie, ModaliteRadiotherapieDto, ModaliteRadiotherapieHistory> {
